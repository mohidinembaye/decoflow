...
function attacherEcouteursConnexion() {
  ...
  formulaire.addEventListener('submit', function(evenement) {
    ...
    var sesSouvenir = document.getElementById('case-souvenir').checked;
    ...
    var utilisateurTrouve = trouverUtilisateurParEmail(emailSaisi);
    ...
    if (sesSouvenir) {
      localStorage.setItem('decoflow_session', JSON.stringify(donneesSession));
    } else {
      sessionStorage.setItem('decoflow_session', JSON.stringify(donneesSession));
    }
