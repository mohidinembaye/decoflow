function afficherPageDashboard(prenomUtilisateur) {
    ...
    <div id="page-dashboard" class="animer-fond w-full min-h-screen bg-beige flex flex-col">
      ...
      <header id="navbar" class="bg-white border-b border-gray-100 px-6 py-3 flex items-center justify-between sticky top-0 z-50">
        ...
        <nav id="navbar-nav" class="hidden md:flex items-center gap-1 flex-1">
          ...
          <a id="nav-orders"      href="#" class="nav-lien px-3 py-1.5 text-sm text-muted hover:text-charcoal border-b-2 border-transparent hover:border-terra-light transition">Orders</a>
          <a id="nav-quotes"      href="#" class="nav-lien px-3 py-1.5 text-sm text-muted hover:text-charcoal border-b-2 border-transparent hover:border-terra-light transition">Quotes</a>
          <a id="nav-customers"   href="#" class="nav-lien px-3 py-1.5 text-sm text-muted hover:text-charcoal border-b-2 border-transparent hover:border-terra-light transition">Customers</a>
        </nav>
        ...
        <div id="grille-principale" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div id="colonne-gauche" class="lg:col-span-2 flex flex-col gap-6">
            ...
            <div id="section-kpi" class="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div id="carte-commandes" class="bg-white rounded-xl p-5 border border-gray-100">
            ...
            <div id="carte-graphique" class="bg-white rounded-xl p-6 sm:p-11 border border-gray-100">
              ...
              <div id="graphique-barres" class="flex items-end justify-between gap-2 h-64">
                <div class="flex flex-col items-center gap-2 flex-1"><div id="barre-lun" data-valeur="55" class="barre-graphique w-full rounded-t-md bg-terra-pale" style="height:55%"></div><span class="text-xs text-muted">LUN</span></div>
                <div class="flex flex-col items-center gap-2 flex-1"><div id="barre-mar" data-valeur="65" class="barre-graphique w-full rounded-t-md bg-terra-pale" style="height:65%"></div><span class="text-xs text-muted">MAR</span></div>
                <div class="flex flex-col items-center gap-2 flex-1"><div id="barre-mer" data-valeur="60" class="barre-graphique w-full rounded-t-md bg-terra-pale" style="height:60%"></div><span class="text-xs text-muted">MER</span></div>
                <div class="flex flex-col items-center gap-2 flex-1"><div id="barre-jeu" data-valeur="100" class="barre-graphique w-full rounded-t-md bg-charcoal"    style="height:100%"></div><span class="text-xs text-muted">JEU</span></div>
                <div class="flex flex-col items-center gap-2 flex-1"><div id="barre-ven" data-valeur="70" class="barre-graphique w-full rounded-t-md bg-terra-pale" style="height:70%"></div><span class="text-xs text-muted">VEN</span></div>
                <div class="flex flex-col items-center gap-2 flex-1"><div id="barre-sam" data-valeur="45" class="barre-graphique w-full rounded-t-md bg-terra-pale" style="height:45%"></div><span class="text-xs text-muted">SAM</span></div>
                <div class="flex flex-col items-center gap-2 flex-1"><div id="barre-dim" data-valeur="40" class="barre-graphique w-full rounded-t-md bg-terra-pale" style="height:40%"></div><span class="text-xs text-muted">DIM</span></div>
              </div>
            </div>
          ...
          <div id="colonne-droite" class="flex flex-col gap-8">
            ...
            <div id="carte-activite" class="bg-white rounded-xl p-5 border border-gray-100 flex-1">
              ...
              <div class="mt-5 pt-4 border-t border-gray-100">
                <a href="#" class="flex items-center justify-between text-sm text-charcoal hover:text-terracotta transition font-medium group">
            ...
            <div id="carte-promo" class="relative rounded-xl overflow-hidden min-h-[340px] bg-charcoal flex flex-col justify-end">
              ...
              <div class="relative z-10 p-5">
                ...
                <a href="#" class="inline-flex items-center gap-1.5 text-xs font-medium text-terra-light hover:text-white transition">
...
function attacherEcouteursDashboard() {
...
(function demarrerApplication() {
  var sessionLocal  = localStorage.getItem('decoflow_session');
  var sessionCourte = sessionStorage.getItem('decoflow_session');

  if (sessionLocal || sessionCourte) {
    var donnees = JSON.parse(sessionLocal || sessionCourte);
    afficherPageDashboard(donnees.nom);
  } else {
